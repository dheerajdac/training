...
public class ControllerServlet extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {            
        	JDBCCarDAO cardao = (JDBCCarDAO) carDAO;
        	...
        	for(Object car: carList){
        		System.out.println(((CarDTO)car).getId());
        	}
        ...
        else if(ADD_CAR_ACTION.equals(actionName))
        {
        	...
        	ServletContext sc = this.getServletContext();
        	response.sendRedirect("carFrom.jsp");
			//TODO 5 
        ...
        else if(EDIT_CAR_ACTION.equals(actionName))
        {
        	JDBCCarDAO cardao = (JDBCCarDAO) carDAO;
        	CarDTO car = new CarDTO();
        	car = cardao.findById(Integer.parseInt(request.getParameter("id")));
        	request.setAttribute("car", car);
        	ServletContext sc = this.getServletContext();
        	response.sendRedirect("carFrom.jsp");
			//TODO 6 
